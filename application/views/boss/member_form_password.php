<section id="position" class="container py-4 ">
    <div class="card shadow border-0 p-4 ">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-6">
                <form action="<?php echo site_url('bosscontroller/update_password') ?>" method="post">
                    <!-- Position -->
                    <div class="mb-3">
                    ...
                    <button type="button" class="btn bg-danger">
                        <a href="<?php echo site_url('bosscontroller') ?>" class="text-white">

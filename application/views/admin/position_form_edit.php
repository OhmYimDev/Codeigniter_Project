<section id="position" class="container py-4 ">
    <div class="card shadow border-0 p-3 ">
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-6">
                <form action="<?php echo site_url('PositionController/update') ?>" method="post">
                    <div class="mb-3">
                        <label for="position name" class="form-label">Position name</label>
                        <input type="text" class="form-control" name="position_name" value="<?php echo $position->p_name ?>" reauired>
                        <input type="hidden" value="<?php echo $position->p_id ?>" name="p_id">
                    </div>

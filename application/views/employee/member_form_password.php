<section id="position" class="container py-4 ">
    <div class="card shadow border-0 p-4 ">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h4>update_employee - Edit Password</h4>
                <hr>
            </div>
        </div>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-lg-6">
                <form action="<?php echo site_url('employeecontroller/update_password') ?>" method="post">
                    <!-- Position -->
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="col-sm-2">
                            <select name="m_prefix" class="form-select" aria-label="Default select example" required disabled>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <input type="text" class="form-control" name="m_fname" value="<?php echo $member->m_fname ?>" reauired disabled>
                            </div>
                        </div>
                    </div>
                    <!-- Last name -->
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <input type="text" class="form-control" name="m_lname" value="<?php echo $member->m_lname ?>" reauired disabled>
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col-sm-8">
                                ...
                                <input type="password" class="form-control" name="m_password" reauired minlength="3">
                            </div>
                        </div>
                    </div>
                    ...
                    <button type="button" class="btn bg-danger">
                        <a href="<?php echo site_url('employeecontroller') ?>" class="text-white">
